...
public class Cripto 
{
	...
	String letras_ ="!@#$%&*?¬®_=+-{}[]0987654321'aAbBcCdDeEfFgGhHiIjJkKlLmMnNoOpPqQrRsStTuUwWvVxXyYzZ |\\,.;:/()·¡„√‚¬‡¿È…Í Ë»ÌÕÏÃÓŒÛ”ı’‘Ù˙⁄˘Ÿ¸‹˚€π≤≥£¢¨∞∫™"+'"';
	
	int divisores[] ={intervalo,divisor1,divisor2,divisor3,divisor4,divisor5,divisor6};
	
	/*Para maior efici√™ncia use n√∫meros de 2 a 33 para os divisores  e n√∫meros pequenos para o intervalo*/
