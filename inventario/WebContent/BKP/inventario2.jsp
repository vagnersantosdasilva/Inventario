...
<HTML>
    <HEAD>
    	...
    	<link href="css/dataTables.bootstrap.css" rel="stylesheet">
    	 <!-- DataTables CSS -->
	    <link href="cssdataTables.bootstrap.css" rel="stylesheet">
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        ...
		        <div class="form-group">
					  ...
					  <input type="text" class="form-control" id="hostname" value="<c:out value="${maquina.hostname}" default=" "/>">
				</div>
				<div class="form-group">
					  <label for="nomeusuario">Nome de Usuário:</label>
					  <input type="text" class="form-control" id="nomeusuario" value="<c:out value="${maquina.usuario.nome}" default=" "/>">
				</div>
				
				<div class="form-group">
					  <label for="login">Login:</label>
					  <input type="text" class="form-control" id="login" value="<c:out value="${maquina.usuario.login}" default=" "/>">
				</div>
				
				<div class="form-group">
					  <label for="localizacao">Localização:</label>
					  <input type="text" class="form-control" id="localizacao" value="<c:out value="${maquina.usuario.localizacao}" default=" "/>">
				</div>
				
				<div class="form-group">
					  <label for="telefone">Telefone:</label>
					  <input type="text" class="form-control" id="telefone" value="<c:out value="${maquina.usuario.telefone}" default=" "/>">
				</div>
				
				<div class="form-group">
					  <label for="email">Email:</label>
					  <input type="text" class="form-control" id="email" value="<c:out value="${maquina.usuario.email}" default=" "/>">
				</div>
				
				<div class="form-group">
					  <label for="email">Patrimônio:</label>
					  <input type="text" class="form-control" id="Patrimônio" value="<c:out value="${maquina.patrimonio}" default=" "/>">
				</div>
				
				<div class="form-group">
					  <label for="email">Número de Série:</label>
					  <input type="text" class="form-control" id="numeroserie" value="<c:out value="${maquina.serie}" default=" "/>">
				</div>
				
				<div class="form-group">
					  <label for="fabricante">Fabricante:</label>
					  <input type="text" class="form-control" id="fabricante" value="<c:out value="${maquina.fabricante}" default=" "/>">
				</div>
				
				<div class="form-group">
					  <label for="modelo">Modelo:</label>
					  <input type="text" class="form-control" id="modelo" value="<c:out value="${maquina.modelo}" default=" "/>">
				</div>
